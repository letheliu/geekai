            ...
            <el-form :model="params" label-width="80px" label-position="left">
              ...
              <div class="param-line" style="padding-top: 10px">
                <el-form-item label="Lora">
                  <template #default>
                    <div class="form-item-inner">
                      <el-select v-model="params.lora" style="width: 176px">
                        <el-option
                          v-for="item in loras"
                          :label="item"
                          :value="item"
...
const loras = ["Lora1", "Lora2", "Lora3", "Lora4", "Lora5", "Lora6"];
...
const connect = () => {
  ...
  const _socket = new WebSocket(
    host + `/api/sd/client?user_id=${userId.value}`
  );
...
onMounted(() => {
  ...
  if (route.query.lora) {
    let n = Number.parseInt(route.query.lora);
    if (n > 0) {
      let _newParams = params.value;
      _newParams.lora = loras[n - 1];
      params.value = _newParams;
    }
  }
